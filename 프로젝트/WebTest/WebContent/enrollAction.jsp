...
<body>
	<%
		...
		if(data.getFlexRadioDefault() == null || data.getAssignmentNum() == 0 || data.getArea1() == null ||data.getNamefull() == null ||
				data.getPhone() == null || data.getTemperatures() == 100 ||data.getWeather() == null ||data.getSurface() == null ||
