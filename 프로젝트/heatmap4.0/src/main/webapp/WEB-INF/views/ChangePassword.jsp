			 ...
			 <a href="/heatmap/mapCheck" class="btn btn-primary">열지도 보기</a>
  			...
  			<div class="btn-group" role="group">
    			<button type="button" class="btn btn-primary active dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
    				...
    				<ul class="dropdown-menu" role="menu">
    				<li class=active><a href="/heatmap/ChangePassword">비밀번호 변경</a></li>
	...
	<div class="container">
		...
		<div class="col-lg-15">
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="ChangePasswordControl">
					...
					<div class="form-group">
						<input type="password" class="form-control" placeholder="현재비밀번호" name="password" maxlength="20" required>
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="비밀번호" name="changepassword" maxlength="20" required>
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="비밀번호" name="changepassword2" maxlength="20" required>
					</div>
					<input type="submit" class="btn btn-primary form-control" value="비밀번호 변경">
				</form>
				<br>
				<a href="/heatmap/" class="btn btn-primary form-control" role="button">취소</a>
			</div>
		</div>
		<div class="col-lg-15"></div>
	</div>
