			  ...
			  <div class="btn-group" role="group">
    			<button type="button" class="btn btn-primary active dropdown-toggle" data-toggle="dropdown" aria-expanded="false" >
    				...
    				<ul class="dropdown-menu" role="menu">
      				...
      				<li class=active><a href="/heatmap/RealLogin">로그인</a></li>
   					 </ul>
  			</div>
	...
	<div class="container">
		...
		<div class="col-lg-15">
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="PasswordControl">
					<h3 style="text-align: center;">비밀번호 찾기</h3>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="아이디" name="userID" maxlength="20" required>
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="이메일" name="userEmail" maxlength="20" required>
					</div>
					<input type="submit" class="btn btn-primary form-control" value="비밀번호 찾기">
				</form>
				<br>
				<a href="/heatmap/RealLogin" class="btn btn-primary form-control" role="button">취소</a>
			</div>
		</div>
		<div class="col-lg-15"></div>
	</div>
